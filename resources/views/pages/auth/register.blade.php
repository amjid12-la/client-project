<x-auth-layout>
    ...
    <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" method="POST"
        ...
        <style>
            /* Hide duplicate error messages - only show the first one */
            .fv-plugins-message-container:not(:first-of-type) {
                display: none !important;
            }
            
            /* Ensure only one error message per field */
            .fv-row .fv-plugins-message-container ~ .fv-plugins-message-container {
                display: none !important;
            }
        </style>
        <!--begin::Heading-->
        ...
        <div class="fv-row mb-8">
            ...
            <input type="text" placeholder="Name" name="name" id="name" autocomplete="off"
                class="form-control bg-transparent" pattern="[A-Za-z\s]+" title="Name must contain only letters and spaces" />
            <!--end::Name-->
        </div>
        ...
        <div class="fv-row mb-8">
            ...
            <div class="position-relative">
                <input placeholder="Repeat Password" id="password_confirmation" name="password_confirmation" type="password" autocomplete="off"
                    class="form-control bg-transparent" />
    ...
    <script>
        // Name field validation - Accept only letters and spaces (max 4 spaces)
